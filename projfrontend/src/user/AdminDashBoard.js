...
const AdminDashBoard = () => {
    ...
    return (
        <Base className="container bg-success p-4" title="Welcome Admin" description="Manage All Your Products Here..." >
            <div className="row" >
                <div className="col-3 p-2" >{adminLeftSide()}</div>
                <div className="col-4 p-2" >{adminRightSide()}</div>
            </div>
